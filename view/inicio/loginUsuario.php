				...
				<div id="form_wrapper" class="form_wrapper">
					<form class="register">
						...
						<div class="column">
							<div>
								...
								<input type="text"/>
								<span class="error">Cont�m um erro</span>
							</div>
							<div>
								<label>E-mail:</label>
								<input type="text" />
						...
						<div class="bottom">
							...
							<a href="index.html" rel="login" class="linkform">Voc� j� possui uma conta? Acesse aqui!</a>
							<div class="clear"></div>
						</div>
					</form>
					<form class="login active" action="index.php?page=loginUsuario" method="post">
						...
						<div class="bottom">
							...
							<a href="register.html" rel="register" class="linkform">Voc� n�o tem uma conta ainda? Registre-se aqui!</a>
							<div class="clear"></div>
						</div>
					</form>
					<form class="forgot_password">
						...
						<div class="bottom">
							...
							<a href="register.html" rel="register" class="linkform">N�o tem uma conta ainda? Registre-se aqui!</a>
							<div class="clear"></div>
						</div>
					</form>
				</div>
